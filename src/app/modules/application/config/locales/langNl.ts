...
export const langNl: LanguageModel = {
  ...
  desktop: {
    ...
    window: {
      ...
      editSettings: 'Instellingen bewerken',
      search: 'Zoeken',
      editCategoryItem: 'Categorie-item bewerken',
      editGroupItem: 'Bewerk groepsitem',
      editStatusItem: 'Statusitem bewerken',
      editTypeItem: 'Type item bewerken',
      addCategoryItem: 'Categorie-item toevoegen',
  ...
  contactManager: {
    ...
    Live: 'Leven',
    Lead: 'Dood',
    contactRecords: 'Neem contact op met Records',
    companyRecords: 'Bedrijfsgegevens',
    ...
    pleaseSpecifyUserAuthDetails: 'Geef gebruikersauthenticatiegegevens op',
    ...
    settings: {
      ...
      item: {
        ...
        TypeName: 'Typ naam',
        backgroundGradientTopColour: 'Achtergrond Kleurverloop Top',
        backgroundGradientBottomColour: 'Achtergrond kleurverloop onder',
        textColour: 'Tekstkleur',
        fieldTooShort: 'uw [FIELD] is te kort. Specificeer iets dat langer is dan [LENGTH] tekens',
      }
    },
  },
  countries: {
