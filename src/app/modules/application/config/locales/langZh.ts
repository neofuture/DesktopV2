...
export const langZh: LanguageModel = {
  ...
  desktop: {
    ...
    window: {
      ...
      editSettings: '编辑设置',
      search: '搜索',
      editCategoryItem: '编辑类别项目',
      editGroupItem: '编辑组项目',
      editStatusItem: '编辑状态项',
      editTypeItem: '编辑类型项目',
      addCategoryItem: '添加类别项目',
      addGroupItem: '添加组项目',
      addStatusItem: '添加状态项',
      addTypeItem: '添加类型项',
      notesHistory: '笔记和历史',
  ...
  contactManager: {
    ...
    pleaseEnterALongerSurname: '请输入更长的姓',
    ...
    settings: {
      ...
      addNewContactCategory: '添加新的联系人类别',
      addNewCompanyCategory: '添加新公司类别',
      contactCategories: '联系类别',
      ...
      item: {
        ...
        backgroundGradientBottomColour: '背景渐变底色',
        textColour: '文字颜色',
        fieldTooShort: '您的[FIELD]太短，请指定比[LENGTH]个字符更长的内容',
      }
    },
  },
  countries: {
