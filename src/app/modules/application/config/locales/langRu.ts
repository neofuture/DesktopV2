...
export const langRu: LanguageModel = {
  ...
  desktop: {
    ribbon: {
      ...
      cancelAddingRecord: 'Отменить добавление новой записи',
    ...
    window: {
      ...
      editSettings: 'Изменить настройки',
      search: 'Поиск',
      editCategoryItem: 'Изменить элемент категории',
      editGroupItem: 'Изменить элемент группы',
      editStatusItem: 'Изменить элемент статуса',
      editTypeItem: 'Изменить тип элемента',
      addCategoryItem: 'Добавить элемент категории',
    ...
    dialog: {
      ...
      discardChanges: 'Отменить изменения',
      areYouSureYouWishToDiscardYourChanges: 'Вы уверены, что хотите отменить свои изменения?',
      discard: 'Отменить',
      deleteRecord: 'Удалить запись',
      areYouSureYouWishToDeleteThisRecord: 'Вы уверены, что хотите удалить эту запись?',
      delete: 'удалять',
    },
    tabBar: {
  ...
  contactManager: {
    ...
    created: 'Создано',
    updated: 'Обновлено',
    lastUpdatedBy: 'Автор последнего обновления',
    lastLogin: 'Последний Войти',
    start: 'Первая запись',
    previous50: 'Назад 50 записей',
    previous: 'Предыдущая запись',
    next: 'Следующая запись',
    next50: 'Вперед 50 записей',
    ...
    contactAssociations: 'Связаться с ассоциациями',
    general: 'Общее',
    ...
    addressNotListed: 'Адрес не указан',
    pleaseWaitLoading: 'Пожалуйста подождите. Загружается ...',
    ...
    'Appointment Booked': 'Назначение забронировано',
    '2nd Appointment Booked': '2-я встреча забронирована',
    'Awaiting Decision': 'В ожидании решения',
    Customer: 'Клиент',
    ...
    Live: 'Жить',
    Lead: 'мертв',
    contactRecords: 'Контактные записи',
    companyRecords: 'Отчеты компании',
    yourRecordHasBeenSaved: 'Ваша запись сохранена',
    pleaseEnterALongerSurname: 'Пожалуйста, введите более длинную фамилию',
    pleaseEnterALongerCompanyName: 'Пожалуйста, введите более длинное название компании',
    pleaseSpecifyUserAuthDetails: 'Укажите данные для аутентификации пользователя',
    yourRecordHasBeenDeleted: 'Ваша запись была удалена',
    notesAndHistoryTab: {
    ...
    settings: {
      ...
      addNewContactCategory: 'Добавить новую категорию контактов',
      addNewCompanyCategory: 'Добавить новую категорию компании',
      contactCategories: 'Категории контактов',
      companyCategories: 'Категории компаний',
      ...
      item: {
        ...
        TypeName: 'Тип Имя',
        backgroundGradientTopColour: 'Цвет фона градиента сверху',
        backgroundGradientBottomColour: 'Фон Градиент Нижний Цвет',
        textColour: 'Цвет текста',
        fieldTooShort: 'ваше [FIELD] слишком короткое, укажите длину более [LENGTH] симв.',
      }
    },
  },
  countries: {
