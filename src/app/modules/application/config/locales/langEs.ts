...
export const langEs: LanguageModel = {
  ...
  desktop: {
    ...
    window: {
      ...
      editSettings: 'Editar ajustes',
      search: 'Buscar',
      editCategoryItem: 'Editar artículo de categoría',
      editGroupItem: 'Editar elemento de grupo',
      editStatusItem: 'Editar elemento de estado',
      editTypeItem: 'Editar tipo de elemento',
      addCategoryItem: 'Agregar artículo de categoría',
      addGroupItem: 'Agregar elemento de grupo',
      addStatusItem: 'Agregar elemento de estado',
      addTypeItem: 'Agregar tipo de artículo',
  ...
  contactManager: {
    ...
    yourRecordHasBeenSaved: 'Tu registro ha sido guardado',
    pleaseEnterALongerSurname: 'Ingrese un apellido más largo',
    ...
    notesAndHistoryTab: {
      ...
      noteComponent: {
        ...
        openNote: 'Abrir nota',
        openSupportTicket: 'Ticket de soporte abierto',
      }
    },
    accountsTab: {
      ok: 'Okay',
    ...
    settings: {
      ...
      item: {
        ...
        backgroundGradientBottomColour: 'Color de fondo degradado de fondo',
        textColour: 'Color del texto',
        fieldTooShort: 'su [FIELD] es demasiado corto. Especifique algo más largo que [LENGTH] caracteres',
      }
    },
  },
  countries: {
