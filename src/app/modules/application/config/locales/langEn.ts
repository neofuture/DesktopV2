...
export const langEn: LanguageModel = {
  ...
  desktop: {
    ...
    dialog: {
      ...
      discardChanges: 'Discard Changes',
      areYouSureYouWishToDiscardYourChanges: 'Are you sure you wish to discard your changes ?',
      discard: 'Discard',
      deleteRecord: 'Delete Record',
      areYouSureYouWishToDeleteThisRecord: 'Are you sure you wish to delete this record ?',
      delete: 'Delete'
    },
    tabBar: {
      autoHide: 'Auto Hide'
